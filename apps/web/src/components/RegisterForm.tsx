...
export default function RegisterForm() {
    ...
    const [authForm, setAuthForm] = useState<SignUpDTO>({ email: "", password: "", phone: 0 })
    ...
    return <form className="p-10 flex gap-2 flex-col" onSubmit={(e) => handleSubmit(e)}>
        ...
        <input type="text" className="px-2 py-1 rounded-sm bg-gray-100 border" name="phone" value={authForm.phone || ""} onChange={(e) => { handleInputChange(e) }} placeholder="Phone" />
